...
const defaultValues = {
  ...
  admissionSemester: "65be4e4adc4f77463642e37b",
  academicDepartment: "65be4c9fdc4f77463642e371",
};
...
const CreateStudent = () => {
  ...
  const { data: dDeta, isLoading: dIsLoading } =
  ...
  const departmentOptions = dDeta?.data?.map((item) => ({
    value: item._id,
    label: item.name,
  }));
